...
{ TPopupDataGridEh }
  ...
  public
    ...
    procedure ResetHighlightSubstr(Text: String);
    property Ctl3D;
...
//    else ControlStyle := [csOpaque, csFramed];
  ...
  FListFields := TListOfFieldsEh.Create;
  FKeyValue := Null;
...
begin
  ...
  if FListField <> nil then
    ...
    else if (DrawMemoText = True) and (FListField.DataType in MemoTypes) then
...
procedure TPopupDataGridEh.ResetHighlightSubstr(Text: String);
begin
  ...
  begin
    ...
    FHighlightTextParams.Color := RGB(255,255,150);
    FHighlightTextParams.ColumnsList.Add(Columns[0]);
