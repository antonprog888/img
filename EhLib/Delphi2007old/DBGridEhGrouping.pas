...
uses Windows, SysUtils, Messages, Classes, Controls, Forms, StdCtrls, Dialogs,
{$IFDEF CIL}
  EhLibVCLNET,
...
{  TGroupRowPanelInfoEh = class(TPersistent)
  ...
  TGridGroupLinePenEh = class(TGridLinePenEh)
  protected
...
//    property ShowRowInGridFooter: Boolean read GetShowRowInGridFooter write SetShowRowInGridFooter;
    property ColumnItems: TGridDataGroupFooterColumnItemsEh read GetColumnItems write SetColumnItems;
    property ParentColor: Boolean read FParentColor write SetParentColor default True;
    property ParentFont: Boolean read FParentFont write SetParentFont default True;
...
type
  ...
  TCollectionCrack = class(TCollection) end;
...
begin
  inherited Create(ARowDefValues);
end;
