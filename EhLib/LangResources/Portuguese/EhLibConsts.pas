...
resourcestring
  SClearSelectedCellsEh = 'Limpar células seleccionadas?';
  ...
  SSTFilterListItem_SortingByDescend = '(Ordem ascendente)';
  SSTFilterListItem_SortingByAscend = '(Ordem descendente)';
