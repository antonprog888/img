...
{                     EhLib v6.0                        }
{                                                       }
{            TIBXDesignDataBaseEh (Build 6.0.01)        }
{                                                       }
...
begin
  ...
  IBXConnectionProviderDesignService := nil; //Not Free, Interface
...
begin
//design-time EditIBDatabase(GetDatabase);
{$IFDEF DESIGNTIME}
...
{$IFDEF DESIGNTIME}
  ...
  RegisterComponents('EhLib', [TIBXConnectionProviderEh]);
