...
{                     EhLib v6.0                        }
{                                                       }
{     TMemTableFieldsEditorEh component (Build 6.0.01)  }
{                                                       }
...
{$ELSE}
  DSDesign, DsnDBCst, PicEdit,
  {$IFDEF EH_LIB_6} StringsEdit, Variants, VCLEditors,
...
{$ENDIF}
  ...
  DBGridEhGrouping, MemTableDataEh;
...
{$ENDIF}
  ...
  RegisterComponents('EhLib', [TSQLConnectionProviderEh]);
