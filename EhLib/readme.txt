EhLib 6.0 Beta Build 6.0.026 Russian version. Full source included.
-------------------------------------------------------------------
...
Start an overview of the library with the main Demo project
...
in the file history.txt.

More detail with the new features can be found in the file -
About EhLib 6 Eng.doc
...
1. You will get all new versions of the library within a year.
2. You will get technical support all the time.
3. You encourage the author to make the components even better.
...
ICQ # 10785451
Skype support contact: ehlib.support